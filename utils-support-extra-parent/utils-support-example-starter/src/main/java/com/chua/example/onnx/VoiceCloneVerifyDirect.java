 ...
 */
public final class VoiceCloneVerifyDirect {

    private VoiceCloneVerifyDirect() {}
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("[tts] 播放: explorer \"" + wavPath + "\"");
        ...
        try {
            ...
            System.out.println("[verify] 匹配: " + matches(text, transcript));
        } catch (Exception e) {
            System.err.println("[stt] 失败: " + e.getMessage());
            e.printStackTrace();
            System.out.println("[verify] 匹配: N/A（STT 不可用）");
        }
    }
