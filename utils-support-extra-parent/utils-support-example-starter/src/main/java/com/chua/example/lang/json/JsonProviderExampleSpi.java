 ...
 *
 * <p>通过统一入口 {@code com.chua.example.runner.RunnerExample --example=json-provider} 调用，
 ...
 * <pre>
 *   # 全部实现（默认）
 *   java RunnerExample --example=json-provider
 *
 *   # 指定实现
 *   java RunnerExample --example=json-provider --type=gson
 *   java RunnerExample --example=json-provider --type=fory
 *   java RunnerExample --example=json-provider --type=fastjson
 * </pre>
 *
 * @author CH
 * @since 4.0.0.42
...
public class JsonProviderExampleSpi implements Example {
    ...
    private boolean testSpiDiscovery(String type, JsonProvider provider) {
        ...
        try {
            ...
            UtilsExample.fail("SPI 发现异常: " + e.getMessage());
            return false;
        }
    }
    ...
    private boolean testSetImplementation(JsonProvider provider) {
        ...
        try {
            ...
            UtilsExample.fail("setImplementation 异常: " + e.getMessage());
            return false;
        }
    }
    ...
    private boolean testUnifiedAnnotations() {
        ...
        try {
            ...
            UtilsExample.fail("统一注解异常: " + e.getMessage());
            return false;
        }
    }
    ...
    private boolean testRoundTrip() {
        ...
        try {
            ...
            UtilsExample.fail("往返异常: " + e.getMessage());
            return false;
        }
    }
    ...
    private boolean testToJsonIgnores(JsonProvider provider) {
        ...
        try {
            ...
            UtilsExample.fail("ignores 异常: " + e.getMessage());
            return false;
        }
    }
    ...
    private boolean testTypeDeserialization(JsonProvider provider, String type) {
        ...
        try {
            ...
            UtilsExample.fail("Type 反序列化异常: " + e.getMessage());
            return false;
        }
    }
    ...
    private boolean testStreamEntries(JsonProvider provider) {
        ...
        try {
            ...
            UtilsExample.fail("stream 入口异常: " + e.getMessage());
            return false;
        }
    }
    ...
    private boolean testNodeFactorySubclasses(Class<?> objCls, Class<?> arrCls, Class<?> nodeCls) {
        ...
        try {
            ...
            UtilsExample.fail("节点工厂异常: " + e.getMessage());
            return false;
        }
    }
