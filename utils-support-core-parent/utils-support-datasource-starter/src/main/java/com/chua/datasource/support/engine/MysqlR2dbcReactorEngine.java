 ...
 *
 * <pre>{@code
 * MysqlR2dbcReactorEngine engine = new MysqlR2dbcReactorEngine();
 ...
 */
@Spi("mysql")
public class MysqlR2dbcReactorEngine extends DefaultReactorEngine {

    /**
     * 创建 MySQL R2DBC 响应式引擎。
     *
     * <p>内部将自动根据数据源配置选择合适的 R2DBC {@link io.r2dbc.spi.ConnectionFactory}。</p>
     */
    ...
    public MysqlR2dbcReactorEngine addDataSource(String name, String host, int port, String database, String username, String password) {
        // R2DCD 数据源配置将在应用层通过 spring.r2dbc.initialization 或 Bean 完成
        return this;
    }
}