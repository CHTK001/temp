 ...
 */
 ...
 try {
 JsonObject result = fromJson(json5, JsonObject.class);
 ...
 */
 ...
 try {
 JsonArray result = fromJson(json5, JsonArray.class);
 ...
 */
 ...
 JsonObject result = fromJson(new String(bytes, charset), JsonObject.class);
 return result != null ? result : new JsonObject();
 }
