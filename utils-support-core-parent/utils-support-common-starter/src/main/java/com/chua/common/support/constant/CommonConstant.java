...
public interface CommonConstant {
     ...
     * 空字符串常量（符号命名风格）。
     */
    String SYMBOL_EMPTY = SYMBOL_EMPTY_STRING;
    /**
     * 空字符串常量。
     */
    String EMPTY_STRING = SYMBOL_EMPTY_STRING;
     ...
     * 未找到索引标记常量 {@value}。
     */
    String INDEX_NOT_FOUND_STRING = String.valueOf(INDEX_NOT_FOUND);
    // ========================== 操作系统属性 ==========================
     ...
     */
    String SYMBOL_LEFT_BIG_PARENTHESES = SYMBOL_LEFT_BRACE;
    /**
     * 右大括号 {@value}。
     */
     ...
     */
    String SYMBOL_RIGHT_BIG_PARENTHESES = SYMBOL_RIGHT_BRACE;
     ...
     */
    String SYMBOL_DASH = SYMBOL_MINUS;
    /**
     * 短横线符号（引用自 SYMBOL_DASH）。
     */
    String SYMBOL_MINS = SYMBOL_DASH;
    /**
     * 加号符号 {@value}。
     */
    String SYMBOL_PLUS = "+";
     ...
     * 数字零的字符串形式 {@value}。
     */
    String SYMBOL_NUMBERS_ZERO_STRING = "0";

    /**
     * 点号的字符串形式 {@value}。
     */
    String SYMBOL_DOT_STRING = ".";
     ...
     * 单引号的字符形式 {@code '\''}。
     */
    char SYMBOL_SINGLE_QUOTATION_MARK_CHAR = '\'';
    /**
     * 竖线符号的字符形式 {@code '|'}。
     */
     ...
     * 换行符的字符形式 {@code '\n'}。
     */
    char SYMBOL_NEWLINE_CHAR = '\n';
    /**
     * 制表符的字符形式 {@code '\t'}。
     */
    char SYMBOL_TAB_CHAR = '\t';
    /**
     * 回车符的字符形式 {@code '\r'}。
     */
    char SYMBOL_RETURN_CHAR = '\r';
     ...
     * 通配符星号（匹配任意字符序列）。
     */
    char WILDCARD_ASTERISK = '*';
    /**
     * 通配符问号（匹配单个任意字符）。
     */
    char WILDCARD_QUESTION = '?';
