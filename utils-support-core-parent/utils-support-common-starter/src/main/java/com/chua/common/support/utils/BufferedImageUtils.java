...
public class BufferedImageUtils {
    ...
    /**
     * 将 GIF 图片按帧拆分为 BufferedImage 数组。
     *
     * @param file GIF 文件
     * @return 每帧一张 BufferedImage，非 GIF 返回单帧数组
     */
    ...
    /**
     * 通过 ImageInputStream 读取 GIF 帧。
     *
     * @param iis GIF 图片输入流
     * @return 每帧一张 BufferedImage
     ...
     * @return data:image/xxx;base64, 开头的 Base64 字符串
     */
