 ...
 *       同一说话人的不同时间段可能持有相同的 ID，便于后续聚类合并。</li>
...
public record SpeakerSegment(
     ...
     * 返回该片段的持续时间（毫秒）。
     *
     * @return 时长（endTimeMs - startTimeMs），若结束时间早于起始时间则返回 0
     */
     ...
     * @return {@code true} 表示该片段与 [startMs, endMs] 有交集
     */
