...
/**
 * ConfigureObjectContext 的默认占位实现。所有 Bean 查询返回 null/empty，getMappingBeanDefinitionRegister 返回一个空的注册器实例。
...
public class DefaultConfigureObjectContext implements ConfigureObjectContext {
    ...
    /**
     * @return 新建的空 MappingBeanDefinitionRegister 实例
     */
    @Override
