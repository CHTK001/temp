 ...
 * 包括认证 Cookie 名、端点、bot_id、事件类型、内容类型等。
 *
...
public final class DoubaoConstants {
    ...
    /**
     * 豆包 Web 首页地址，用于加载页面并触发 fetch hook 注入签名。
     */
    ...
    /**
     * 认证 Cookie：设备绑定 token。
     */
    public static final String COOKIE_TTWID = "ttwid";

    /**
     * 认证 Cookie：CSRF 防护 token，同时作为 {code a-csrf-token} 请求头。
     */
