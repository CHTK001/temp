...
public class OnnxModelRegistrar implements ModelRegistrar {
    ...
    private static void registerAll() {
        ...
        // 车牌检测(YOLOv11-v1x)：YOLOv11 架构最准版（227MB，mAP 0.98），唯一保留；自动下载
        reg("yolov11-plate-detect-v1x", "com.chua.deeplearning.support.onnx.yolo.plate.translator.Yolov11PlateDetectTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.cv.output.DetectedObjects.class, com.chua.deeplearning.support.image.ImageDetector.class, "vision/detection/yolov5_plate/yolov5_plate_v1x.onnx", "https://huggingface.co/morsetechlab/yolov11-license-plate-detection/resolve/main/license-plate-finetune-v1x.onnx", false, null);
