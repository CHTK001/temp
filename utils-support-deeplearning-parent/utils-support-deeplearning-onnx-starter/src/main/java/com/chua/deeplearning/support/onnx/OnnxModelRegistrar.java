...
public class OnnxModelRegistrar implements ModelRegistrar {
    ...
    private static void registerAll() {
        ...
        // ==================== 通用物体检测 (轻量 YOLO 系列) ====================
        reg("yolov8n", "com.chua.deeplearning.support.onnx.yolo.v8.translator.YoloV8sTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.cv.output.DetectedObjects.class, com.chua.deeplearning.support.image.ImageDetector.class, "vision/detection/v8/yolov8n.onnx", "https://huggingface.co/onnx-community/yolov8n/resolve/main/onnx/model.onnx", false, null);
        reg("yolo11n-seg", "com.chua.deeplearning.support.onnx.yolo.v11.translator.Yolo11OddTranslator", ai.djl.modality.cv.Image.class, Object.class, Object.class, "vision/detection/v11/yolo11n-seg.onnx", "https://huggingface.co/onnx-community/yolo11n-seg/resolve/main/onnx/model.onnx", false, null);
        reg("yolo26s", "com.chua.deeplearning.support.onnx.yolo.v26.translator.Yolo26ObbTranslator", ai.djl.modality.cv.Image.class, Object.class, Object.class, "vision/detection/v26/yolo26s.onnx", "https://huggingface.co/onnx-community/yolo26s-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("yolo11n-pose", "com.chua.deeplearning.support.onnx.pose.VitPoseTranslator", ai.djl.modality.cv.Image.class, float[][].class, Object.class, "vision/pose/yolo11n-pose.onnx", "https://huggingface.co/onnx-community/yolo11n-pose/resolve/main/onnx/model.onnx", false, null);

        // ==================== 轻量分类 (移动端优化) ====================
        reg("mobilenetv4-conv-small", "com.chua.deeplearning.support.onnx.classification.EfficientNetLite0ClassificationTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.Classifications.class, com.chua.deeplearning.support.image.ImageClassifier.class, "vision/classification/mobilenetv4/mobilenetv4_conv_small.onnx", "https://huggingface.co/onnx-community/mobilenetv4_conv_small.e2400_r224_in1k/resolve/main/onnx/model.onnx", false, null);
        reg("efficientnet-b0", "com.chua.deeplearning.support.onnx.classification.EfficientNetLite0ClassificationTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.Classifications.class, com.chua.deeplearning.support.image.ImageClassifier.class, "vision/classification/efficientnet-b0/efficientnet_b0.onnx", "https://huggingface.co/onnx-community/efficientnet-b0-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("efficientnet-b1", "com.chua.deeplearning.support.onnx.classification.EfficientNetLite0ClassificationTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.Classifications.class, com.chua.deeplearning.support.image.ImageClassifier.class, "vision/classification/efficientnet-b1/efficientnet_b1.onnx", "https://huggingface.co/onnx-community/efficientnet-b1-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("ghostnetv2-100", "com.chua.deeplearning.support.onnx.classification.EfficientNetLite0ClassificationTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.Classifications.class, com.chua.deeplearning.support.image.ImageClassifier.class, "vision/classification/ghostnetv2/ghostnetv2_100.onnx", "https://huggingface.co/onnx-community/ghostnetv2_100-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("shufflenetv2-x10", "com.chua.deeplearning.support.onnx.classification.EfficientNetLite0ClassificationTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.Classifications.class, com.chua.deeplearning.support.image.ImageClassifier.class, "vision/classification/shufflenetv2/shufflenetv2_x1.0.onnx", "https://huggingface.co/onnx-community/shufflenet-v2-x1.0-ONNX/resolve/main/onnx/model.onnx", false, null);

        // ==================== 人脸分析增强 ====================
        reg("yolov8n-face", "com.chua.deeplearning.support.onnx.face.UltraFaceTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.cv.output.DetectedObjects.class, com.chua.deeplearning.support.image.ImageDetector.class, "face/detection/yolov8n-face.onnx", "https://huggingface.co/onnx-community/yolov8n-face-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("face-landmark-106", "com.chua.deeplearning.support.onnx.face.FacePluginLandmarkTranslator", ai.djl.modality.cv.Image.class, float[].class, com.chua.deeplearning.support.feature.FeatureExtractor.class, "face/landmark/landmark-106/model.onnx", "https://huggingface.co/onnx-community/face-landmark-106-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("face-quality-mobilenet", "com.chua.deeplearning.support.onnx.classification.EfficientNetLite0ClassificationTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.Classifications.class, com.chua.deeplearning.support.image.ImageClassifier.class, "face/quality/mobilenet/model.onnx", "https://huggingface.co/onnx-community/face-quality-mobilenet-ONNX/resolve/main/onnx/model.onnx", false, null);

        // ==================== 人体姿态/手势 ====================
        reg("blazepose", "com.chua.deeplearning.support.onnx.pose.VitPoseTranslator", ai.djl.modality.cv.Image.class, float[][].class, Object.class, "vision/pose/blazepose/model.onnx", "https://huggingface.co/onnx-community/blazepose-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("yolov8n-hand", "com.chua.deeplearning.support.onnx.yolo.v8.translator.YoloV8sTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.cv.output.DetectedObjects.class, com.chua.deeplearning.support.image.ImageDetector.class, "vision/detection/yolov8n-hand.onnx", "https://huggingface.co/onnx-community/yolov8n-hand-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("mediapipe-hand-landmarker", "com.chua.deeplearning.support.onnx.reid.HandPoseTranslator", ai.djl.modality.cv.Image.class, float[].class, com.chua.deeplearning.support.feature.FeatureExtractor.class, "vision/handpose/hand_landmarker.onnx", "https://huggingface.co/onnx-community/mediapipe-hand-landmarker-ONNX/resolve/main/onnx/model.onnx", false, null);

        // ==================== 车牌增强 (多国家) ====================
        reg("chinese-plate-yolov8n", "com.chua.deeplearning.support.onnx.yolo.plate.translator.Yolo8PlateDetectTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.cv.output.DetectedObjects.class, com.chua.deeplearning.support.image.ImageDetector.class, "vision/detection/license/chinese-plate-yolov8n.onnx", "https://huggingface.co/onnx-community/chinese-plate-yolov8n-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("european-plate-yolov8n", "com.chua.deeplearning.support.onnx.yolo.plate.translator.Yolo8PlateDetectTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.cv.output.DetectedObjects.class, com.chua.deeplearning.support.image.ImageDetector.class, "vision/detection/license/european-plate-yolov8n.onnx", "https://huggingface.co/onnx-community/european-plate-yolov8n-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("jp-plate-yolov8n", "com.chua.deeplearning.support.onnx.yolo.plate.translator.Yolo8PlateDetectTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.cv.output.DetectedObjects.class, com.chua.deeplearning.support.image.ImageDetector.class, "vision/detection/license/jp-plate-yolov8n.onnx", "https://huggingface.co/onnx-community/jp-plate-yolov8n-ONNX/resolve/main/onnx/model.onnx", false, null);

        // ==================== 文档/OCR 增强 ====================
        reg("chinese-ocr-det-ppocrv4", "com.chua.deeplearning.support.onnx.ocr.direction.PpWordRotateTranslator", ai.djl.modality.cv.Image.class, Object.class, Object.class, "ocr/detection/ch_ppocrv4_det.onnx", "https://huggingface.co/onnx-community/ch_ppocrv4_det-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("chinese-ocr-rec-crnn-mobile", "com.chua.deeplearning.support.onnx.ocr.extractor.PpWordExtractorTranslator", ai.djl.modality.cv.Image.class, String.class, Object.class, "ocr/recognition/ch_ppocrv4_mobile_rec.onnx", "https://huggingface.co/onnx-community/ch_ppocrv4_mobile_rec-ONNX/resolve/main/onnx/model.onnx", false, null);

        // ==================== 文本嵌入/检索 ====================
        reg("e5-base-v2", "com.chua.deeplearning.support.onnx.clip.ClipTextFeatureTranslator", String.class, float[].class, Object.class, "nlp/embedding/e5-base-v2/model.onnx", "https://huggingface.co/onnx-community/e5-base-v2-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("bge-base-zh-v15", "com.chua.deeplearning.support.onnx.clip.ClipTextFeatureTranslator", String.class, float[].class, Object.class, "nlp/embedding/bge-base-zh-v1.5/model.onnx", "https://huggingface.co/onnx-community/bge-base-zh-v1.5-ONNX/resolve/main/onnx/model.onnx", false, null);

        // ==================== ASR/TTS ====================
        reg("whisper-tiny", "com.chua.deeplearning.support.onnx.text.BertSquadTranslator", String.class, String.class, Object.class, "nlp/audio/whisper-tiny/model.onnx", "https://huggingface.co/onnx-community/whisper-tiny-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("silero-vad", "com.chua.deeplearning.support.onnx.text.BertSquadTranslator", String.class, String.class, Object.class, "nlp/audio/silero-vad/model.onnx", "https://huggingface.co/onnx-community/silero-vad-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("vits-chinese", "com.chua.deeplearning.support.onnx.seq2seq.T5Seq2SeqTranslator", String.class, String.class, Object.class, "nlp/audio/vits-chinese/model.onnx", "https://huggingface.co/onnx-community/vits-chinese-ONNX/resolve/main/onnx/model.onnx", false, null);

        // ==================== 超分辨率增强 ====================
        reg("real-esrgan-anime", "com.chua.deeplearning.support.onnx.resolution.RealEsrganTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.cv.Image.class, Object.class, "vision/enhancement/realesrgan-anime/model.onnx", "https://huggingface.co/onnx-community/RealESRGAN-anime-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("realesrgan-x2plus", "com.chua.deeplearning.support.onnx.resolution.RealEsrganTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.cv.Image.class, Object.class, "vision/enhancement/realesrgan-x2plus/model.onnx", "https://huggingface.co/onnx-community/RealESRGAN-x2plus-ONNX/resolve/main/onnx/model.onnx", false, null);

        // ==================== 异常检测 ====================
        reg("patchcore-anomaly", "com.chua.deeplearning.support.onnx.feature.ClipImageFeatureTranslator", ai.djl.modality.cv.Image.class, float[].class, com.chua.deeplearning.support.feature.FeatureExtractor.class, "vision/anomaly/patchcore/model.onnx", "https://huggingface.co/onnx-community/patchcore-anomaly-ONNX/resolve/main/onnx/model.onnx", false, null);
        reg("efficientad-anomaly", "com.chua.deeplearning.support.onnx.classification.EfficientNetLite0ClassificationTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.Classifications.class, com.chua.deeplearning.support.image.ImageClassifier.class, "vision/anomaly/efficientad/model.onnx", "https://huggingface.co/onnx-community/EfficientAD-ONNX/resolve/main/onnx/model.onnx", false, null);

        // ==================== 文档版面增强 ====================
        reg("doclayout-yolo-nano", "com.chua.deeplearning.support.onnx.yolo.v10.translator.DocLayoutYoloTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.cv.output.DetectedObjects.class, com.chua.deeplearning.support.layout.LayoutDetector.class, "vision/detection/doclayout-yolo-nano/model.onnx", "https://huggingface.co/onnx-community/doclayout-yolo-nano-ONNX/resolve/main/onnx/model.onnx", false, null);

        // ==================== 通用物体检测扩展 ====================
        reg("rt-detr-r18", "com.chua.deeplearning.support.onnx.yolo.v10.translator.DocLayoutYoloTranslator", ai.djl.modality.cv.Image.class, ai.djl.modality.cv.output.DetectedObjects.class, com.chua.deeplearning.support.image.ImageDetector.class, "vision/detection/rt-detr/rt-detr-r18.onnx", "https://huggingface.co/onnx-community/rt-detr-r18-ONNX/resolve/main/onnx/model.onnx", false, null);
    }
