 ...
 */
@Slf4j
public class Yolo8IdCardDetectTranslator implements Translator<Image, DetectedObjects> {
 ...
 // topk
        ...
        for (float[] row : data) {
            ...
            float prob = score;
            String className = classIndex == 0 ? "id-card" : "id-card";
