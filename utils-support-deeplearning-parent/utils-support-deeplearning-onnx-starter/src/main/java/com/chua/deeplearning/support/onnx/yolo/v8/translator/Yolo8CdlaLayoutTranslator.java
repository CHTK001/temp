 ...
 * <p>
 *        YOLOv8                                                                                                    
 *                https://github.com/jiangnanboy/layout_detection
 *                https://github.com/jiangnanboy/layout_analysis4j
 *             https://github.com/buptlihang/CDLA
 * <p>
 * CDLA   Chinese Document Layout Analysis                                                
 *                                                  5000                 1000                
 * <p>
 * YOLOv8                            
 * -        shape: [1, 4+num_classes, num_boxes]        [1, 14, 8400]
 * -          : [num_boxes, 4+num_classes]        [8400, 14]
 * -     4              (cx, cy, w, h)
 * -                                                           confidence          
 ...
 */
@Slf4j
public class Yolo8CdlaLayoutTranslator implements Translator<Image, DetectedObjects> {
     ...
     * 10                            
     */
    public static final List<String> CDLA_LAYOUT_CLASSES = Arrays.asList(
        "Header",
        "Text",
        "Reference",
        "Figure caption",
     ...
     *        NMS          CDLA        0.4   
     */
    private static final float DEFAULT_NMS_THRESHOLD = 0.4f;
     ...
     *                    -                   
     */
    public Yolo8CdlaLayoutTranslator() {
        this(DEFAULT_INPUT_SIZE, DEFAULT_THRESHOLD, DEFAULT_NMS_THRESHOLD, CDLA_LAYOUT_CLASSES);
    }
     ...
     * @param inputSize                                  
     */
    public Yolo8CdlaLayoutTranslator(int inputSize) {
        this(inputSize, DEFAULT_THRESHOLD, DEFAULT_NMS_THRESHOLD, CDLA_LAYOUT_CLASSES);
    }
     ...
     */
    public Yolo8CdlaLayoutTranslator(int inputSize, float threshold, float nmsThreshold) {
        this(inputSize, threshold, nmsThreshold, CDLA_LAYOUT_CLASSES);
    }
     ...
     * @param classes                  
     */
    public Yolo8CdlaLayoutTranslator(int inputSize, float threshold, float nmsThreshold, List<String> classes) {
        this.inputSize = inputSize;
        this.threshold = threshold;
        this.nmsThreshold = nmsThreshold;
        this.classes = new ArrayList<>(classes);
        this.normalizeCoordinates = true;
        log.info("          YOLOv8                                   (CDLA) -             : {}x{},       : {}, NMS: {},          : {}",
    ...
    public DetectedObjects processOutput(TranslatorContext ctx, NDList list) throws Exception {
        ...
        //                   
        // YOLOv8             : [4+num_classes, num_boxes]        [14, 8400]
        //                : [num_boxes, 4+num_classes]        [8400, 14]
    ...
    public String getModelDescription() {
        return "YOLOv8 Chinese Document Layout Detection (CDLA) - " +
