package com.chua.deeplearning.support.onnx.ocr.paddleocr;
...
/**
 * PaddleOCR        Translator (ONNX)
 *
 * @author CH
 * @since 2025-01-20
 */
@Slf4j
public class PaddleOcrRecognitionTranslator implements Translator<Image, String> {
     ...
     * @param arguments             
     */
    public PaddleOcrRecognitionTranslator(Map<String, ?> arguments) {
