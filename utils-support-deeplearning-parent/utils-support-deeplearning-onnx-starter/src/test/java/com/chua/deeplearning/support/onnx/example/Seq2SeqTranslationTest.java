...
class Seq2SeqTranslationTest {
    ...
    /**
     * mT5-small 中文多句 → 单句摘要测试（modelscope 下载，支持中文）。
     */
    @Test
    ...
    void mt5ChineseSummarize() {
        ...
        System.out.println("[mt5-seq2seq] 输入(两句话): " + source);
    ...
    /**
     * 真实语料样本评估：不同文体的中文文本走 mT5-small，展示真实输出边界。
     */
    @Test
