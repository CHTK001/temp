package com.chua.deeplearning.support._3d.config;
...
import com.chua.deeplearning.support._3d.provider.ForgeStyleApiModel3DGenerator;
...
@ConditionalOnProperty(prefix = "chua.deeplearning._3d", name = "enable", havingValue = "true", matchIfMissing = true)
...
public class GenerationApiModel3DGenerator {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "chua.deeplearning._3d", name = "text-to-3d-enable", havingValue = "true", matchIfMissing = true)
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "chua.deeplearning._3d", name = "image-to-3d-enable", havingValue = "true", matchIfMissing = true)
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "chua.deeplearning._3d", name = "sketch-to-3d-enable", havingValue = "true", matchIfMissing = true)
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "chua.deeplearning._3d", name = "generator-enable", havingValue = "true", matchIfMissing = true)
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "chua.deeplearning._3d", name = "stylizer-enable", havingValue = "true", matchIfMissing = true)
