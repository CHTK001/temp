    ...
    private int[] mapPalette(int t) {
        ...
        switch (palette) {
            ...
            case JET:
                ...
                if (x < 0.125) {
                    r = 0; g = 0; b = (int) (255 * x * 8);
                } else if (x < 0.375) {
                    r = 0; g = (int) (255 * (x - 0.125) * 4); b = 255;
                } else if (x < 0.625) {
                    r = 0; g = 255; b = (int) (255 * (0.625 - x) * 4);
                } else if (x < 0.875) {
                    r = (int) (255 * (x - 0.625) * 4); g = 255; b = 0;
                } else {
                    r = 255; g = (int) (255 * (0.875 - x + 0.125) * 8); b = 0;
                }
                break;
            case IRONBOW:
            default:
                // 黑→深蓝→紫→红→橙→黄→白
                if (x < 0.1) {
                    r = (int) (90 * x * 10); g = 0; b = (int) (180 * x * 10);
                } else if (x < 0.3) {
                    r = (int) (90 + (140 - 90) * (x - 0.1) * 5); g = (int) (40 * (x - 0.1) * 5); b = (int) (180 - 100 * (x - 0.1) * 5);
                } else if (x < 0.55) {
                    r = (int) (140 + (240 - 140) * (x - 0.3) / 0.25); g = (int) (40 + (80 - 40) * (x - 0.3) / 0.25); b = (int) (80 - 80 * (x - 0.3) / 0.25);
                } else if (x < 0.8) {
                    r = 240; g = (int) (80 + (220 - 80) * (x - 0.55) / 0.25); b = 0;
                } else {
                    r = 255; g = 255; b = (int) ((x - 0.8) * 5 * 255);
                }
                break;
        }
        return new int[]{
