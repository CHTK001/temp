...
public class PNGMetadataFormatResources extends ListResourceBundle {
 ...
 // 节点 名称, followed by description
        ...
        { "cICP", "The cICP chunk, containing coding-independent code points (CICP) for video signal type identification" },
        { "eXIf", "The eXIf chunk, containing an Exif profile" },
        ...
        { "acTL", "The acTL chunk, containing the animation info" },
        { "fcTL", "The fcTL chunk, containing the image info" },
        { "fdAT", "The fdAT chunk, containing the image data" },
...
"The filtering method used for compression, always \"adaptive\"" },
        ...
        { "cICP/colourPrimaries", "The colour primaries" },
        { "cICP/transferFunction", "The transfer function" },
        { "cICP/matrixCoefficients", "The matrix coefficients" },
        { "cICP/videoFullRangeFlag", "The video full range flag" },

        { "eXIf/data", "The raw Exif data" },
        ...
        { "fcTL/sequence_number",
                "The sequence number of this fcTL chunk" },
        { "fcTL/width",
        ...
        { "fcTL/delay_num",
                "The numerator of the delay fraction" },
        { "fcTL/delay_den",
                "The denominator of the delay fraction" },
        { "fcTL/dispose_op",
                "The type of image area disposal to be done after rendering this image" },
        { "fcTL/blend_op",
                "The type of how the image to be blended" },

        { "fdAT/sequence_number",
                "The sequence number of this fdAT chunk" },

        { "acTL/num_frames", "The total number of frames in the animation" },
        { "acTL/num_plays", "The number of times that this animation should play" },
