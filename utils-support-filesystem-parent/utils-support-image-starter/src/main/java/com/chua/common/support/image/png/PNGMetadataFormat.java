...
public class PNGMetadataFormat extends IIOMetadataFormatImpl {
    ...
    private PNGMetadataFormat() {
        ...
        // root -> cICP
        addElement("cICP", PNGMetadata.nativeMetadataFormatName,
                   CHILD_POLICY_EMPTY);

        addAttribute("cICP", "colourPrimaries",
                     DATATYPE_INTEGER, true, null,
                VALUE_0, VALUE_255, true, true);

        addAttribute("cICP", "transferFunction",
                DATATYPE_INTEGER, true, null,
                VALUE_0, VALUE_255, true, true);

        addAttribute("cICP", "matrixCoefficients",
                DATATYPE_INTEGER, true, null,
                VALUE_0, VALUE_255, true, true);

        addAttribute("cICP", "videoFullRangeFlag",
                DATATYPE_BOOLEAN, true, null);

        // root -> eXIf
        addElement("eXIf", PNGMetadata.nativeMetadataFormatName,
                   CHILD_POLICY_EMPTY);

        addObjectValue("eXIf", byte.class, 0, Integer.MAX_VALUE);
        ...
        // root -> acTL
        addElement("acTL", PNGMetadata.nativeMetadataFormatName,
                CHILD_POLICY_EMPTY);

        addAttribute("acTL", "num_frames",
                DATATYPE_INTEGER, true, null,
                VALUE_1, VALUE_MAX_32, true, true);

        addAttribute("acTL", "num_plays",
                DATATYPE_INTEGER, true, null,
                VALUE_0, VALUE_MAX_32, true, true);
        ...
        addAttribute("fcTL", "width",
                DATATYPE_INTEGER, true, null,
                "1", "2147483647", true, true);
        addAttribute("fcTL", "height",
                DATATYPE_INTEGER, true, null,
                "1", "2147483647", true, true);
        addAttribute("fcTL", "x_offset",
                DATATYPE_INTEGER, true, null,
                "0", "2147483647", true, true);
        addAttribute("fcTL", "y_offset",
                DATATYPE_INTEGER, true, null,
                "0", "2147483647", true, true);
        addAttribute("fcTL", "delay_num",
                DATATYPE_INTEGER, true, null,
                "0", "65535", true, true);
        addAttribute("fcTL", "delay_den",
                DATATYPE_INTEGER, true, null,
                "0", "65535", true, true);
        addAttribute("fcTL", "dispose_op",
                DATATYPE_INTEGER, true, null,
                "0", "255", true, true);
        addAttribute("fcTL", "blend_op",
                DATATYPE_INTEGER, true, null,
                "0", "255", true, true);
