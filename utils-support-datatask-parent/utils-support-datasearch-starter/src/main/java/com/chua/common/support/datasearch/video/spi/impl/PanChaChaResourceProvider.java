...
/**
 * 盘查查 (panchacha) 网盘搜索提供器
 */
@Spi("panchacha")
public class PanChaChaResourceProvider extends AbstractResourceProvider {
    public PanChaChaResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.panchacha.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("panchacha 搜索失败: " + e.getMessage()); }
    }
}
