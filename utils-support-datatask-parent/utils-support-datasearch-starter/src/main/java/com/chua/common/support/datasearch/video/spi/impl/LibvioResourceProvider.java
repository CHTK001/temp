 ...
 */
@Spi("libvio")
public class LibvioResourceProvider extends AbstractResourceProvider {

    private static final String SEARCH_URL = "https://www.libvio.app/search?keyword=";

    public LibvioResourceProvider() { super(); }
    public LibvioResourceProvider(com.chua.common.support.datasearch.video.model.VideoSource vs) { super(vs); }
    ...
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            return ReturnPageResult.error("libvio 搜索失败: " + e.getMessage());
        }
    }
