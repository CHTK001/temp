 ...
 */
@Spi("ahhhhfs")
public class AhhhhfsResourceProvider extends AbstractResourceProvider {
    public AhhhhfsResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.ahhhhfs.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("啊哈哈资源");
                v.setVideoPlatform("ahhhhfs");
        ...
        } catch (Exception e) { return ReturnPageResult.error("ahhhhfs 搜索失败: " + e.getMessage()); }
    }
}
