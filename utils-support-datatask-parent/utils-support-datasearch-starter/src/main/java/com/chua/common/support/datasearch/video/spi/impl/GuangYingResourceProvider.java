 ...
 */
@Spi("gying")
public class GuangYingResourceProvider extends AbstractResourceProvider {
    public GuangYingResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.gying.cc/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("gying 搜索失败: " + e.getMessage()); }
    }
}
