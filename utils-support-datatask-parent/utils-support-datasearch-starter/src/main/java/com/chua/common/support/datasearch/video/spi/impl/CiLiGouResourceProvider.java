 ...
 */
@Spi("ciligou")
public class CiLiGouResourceProvider extends AbstractResourceProvider {
    public CiLiGouResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.ciligou.me/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("磁力狗资源");
                v.setVideoPlatform("ciligou");
        ...
        } catch (Exception e) { return ReturnPageResult.error("ciligou 搜索失败: " + e.getMessage()); }
    }
}
