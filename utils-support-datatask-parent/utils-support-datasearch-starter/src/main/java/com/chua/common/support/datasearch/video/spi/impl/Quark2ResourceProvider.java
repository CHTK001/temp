 ...
 */
@Spi("quark2")
public class Quark2ResourceProvider extends AbstractResourceProvider {
    public Quark2ResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.quark2.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("夸克盘资源");
                v.setVideoPlatform("quark2");
        ...
        } catch (Exception e) { return ReturnPageResult.error("quark2 搜索失败: " + e.getMessage()); }
    }
}
