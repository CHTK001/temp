...
/**
 * 蚂蚁盘2 (mayipan2) 网盘搜索提供器
 */
@Spi("mayipan2")
public class MayiPan2ResourceProvider extends AbstractResourceProvider {
    public MayiPan2ResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.mayipan2.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("蚂蚁盘2资源");
                v.setVideoPlatform("mayipan2");
        ...
        } catch (Exception e) { return ReturnPageResult.error("mayipan2 搜索失败: " + e.getMessage()); }
    }
}
