...
/**
 * 云盘搜 (yunpansou) 网盘搜索提供器
 */
@Spi("yunpansou")
public class YunPanSouResourceProvider extends AbstractResourceProvider {
    public YunPanSouResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.yunpansou.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("云盘搜资源");
                v.setVideoPlatform("yunpansou");
        ...
        } catch (Exception e) { return ReturnPageResult.error("yunpansou 搜索失败: " + e.getMessage()); }
    }
}
