 ...
 */
@Spi("kks")
public class KksResourceProvider extends AbstractResourceProvider {
    public KksResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.kks.so/search?keyword=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("KKS资源");
                v.setVideoPlatform("kks");
        ...
        } catch (Exception e) { return ReturnPageResult.error("kks 搜索失败: " + e.getMessage()); }
    }
}
