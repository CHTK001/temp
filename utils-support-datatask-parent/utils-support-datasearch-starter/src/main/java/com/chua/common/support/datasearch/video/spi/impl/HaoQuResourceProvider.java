 ...
 */
@Spi("haoqu")
public class HaoQuResourceProvider extends AbstractResourceProvider {

    private static final String SEARCH_URL = "https://www.haoqu.cc/search?keyword=";

    public HaoQuResourceProvider() { super(); }
    public HaoQuResourceProvider(com.chua.common.support.datasearch.video.model.VideoSource vs) { super(vs); }
    ...
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            return ReturnPageResult.error("haoqu 搜索失败: " + e.getMessage());
        }
    }
