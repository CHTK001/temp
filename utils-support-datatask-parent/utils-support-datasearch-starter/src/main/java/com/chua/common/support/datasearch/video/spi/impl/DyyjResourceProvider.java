 ...
 */
@Spi("dyyj")
public class DyyjResourceProvider extends AbstractResourceProvider {

    private static final String SEARCH_URL = "https://www.dyyj.pro/search?keyword=";

    public DyyjResourceProvider() { super(); }
    public DyyjResourceProvider(com.chua.common.support.datasearch.video.model.VideoSource vs) { super(vs); }
    ...
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            return ReturnPageResult.error("dyyj 搜索失败: " + e.getMessage());
        }
    }
