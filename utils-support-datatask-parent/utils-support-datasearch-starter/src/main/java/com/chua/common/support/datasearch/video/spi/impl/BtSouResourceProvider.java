 ...
 */
@Spi("btsou")
public class BtSouResourceProvider extends AbstractResourceProvider {
    public BtSouResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.btsou.cc/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("BT搜资源");
                v.setVideoPlatform("btsou");
        ...
        } catch (Exception e) { return ReturnPageResult.error("btsou 搜索失败: " + e.getMessage()); }
    }
}
