 ...
 */
@Spi("cilizhu")
public class CiLiZhuResourceProvider extends AbstractResourceProvider {
    public CiLiZhuResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.cilizhu.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("磁力猪资源");
                v.setVideoPlatform("cilizhu");
        ...
        } catch (Exception e) { return ReturnPageResult.error("cilizhu 搜索失败: " + e.getMessage()); }
    }
}
