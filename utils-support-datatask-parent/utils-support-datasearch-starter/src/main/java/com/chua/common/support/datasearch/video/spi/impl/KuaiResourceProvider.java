 ...
 */
@Spi("kuai")
public class KuaiResourceProvider extends AbstractResourceProvider {
    public KuaiResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.kuaipan.cn/search?keyword=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("kuai 搜索失败: " + e.getMessage()); }
    }
}
