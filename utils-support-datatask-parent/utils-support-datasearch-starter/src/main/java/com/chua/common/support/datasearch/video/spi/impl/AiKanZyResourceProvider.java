 ...
 */
@Spi("aikanzy")
public class AiKanZyResourceProvider extends AbstractResourceProvider {
    public AiKanZyResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.aikanzy8.com/search?keyword=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("aikanzy 搜索失败: " + e.getMessage()); }
    }
}
