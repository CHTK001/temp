 ...
 */
@Spi("ciliniu")
public class CiLiNiuResourceProvider extends AbstractResourceProvider {
    public CiLiNiuResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.cilinuu.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("磁力牛资源");
                v.setVideoPlatform("ciliniu");
        ...
        } catch (Exception e) { return ReturnPageResult.error("ciliniu 搜索失败: " + e.getMessage()); }
    }
}
