 ...
 */
@Spi("cilimao")
public class CiLiMaoResourceProvider extends AbstractResourceProvider {
    public CiLiMaoResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.cilimao.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("磁力猫资源");
                v.setVideoPlatform("cilimao");
        ...
        } catch (Exception e) { return ReturnPageResult.error("cilimao 搜索失败: " + e.getMessage()); }
    }
}
