...
/**
 * 盘多宝 (panduobao) 网盘搜索提供器
 */
@Spi("panduobao")
public class PanDuoBaoResourceProvider extends AbstractResourceProvider {
    public PanDuoBaoResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.panduobao.com/search?keyword=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("盘多宝资源");
                v.setVideoPlatform("panduobao");
        ...
        } catch (Exception e) { return ReturnPageResult.error("panduobao 搜索失败: " + e.getMessage()); }
    }
}
