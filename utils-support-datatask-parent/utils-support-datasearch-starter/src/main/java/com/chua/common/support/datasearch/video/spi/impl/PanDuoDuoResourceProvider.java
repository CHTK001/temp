...
/**
 * 盘多多 (panduoduo) 网盘搜索提供器
 *
 * @author CH
 * @since 4.0.0.42
 */
@Spi("panduoduo")
public class PanDuoDuoResourceProvider extends AbstractResourceProvider {

    private static final String API_URL = "https://www.panduoduo.net/api/v1/search";

    public PanDuoDuoResourceProvider() { super(); }
    public PanDuoDuoResourceProvider(com.chua.common.support.datasearch.video.model.VideoSource vs) { super(vs); }
    ...
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            return ReturnPageResult.error("panduoduo 搜索失败: " + e.getMessage());
        }
    }
