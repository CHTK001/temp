...
/**
 * 夸克TV2 (quarktv2) 网盘搜索提供器
 */
@Spi("quarktv2")
public class QuarkTv2ResourceProvider extends AbstractResourceProvider {
    public QuarkTv2ResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.quarktv2.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            java.util.regex.Matcher m = java.util.regex.Pattern.compile("href=\"([^\"]*quark\\.cn[^\"]+)\"").matcher(resp.body());
            int idx = 0;
            while (m.find() && idx++ < 10) {
                VideoInfoResult v = new VideoInfoResult();
                v.setVideoName("夸克TV2资源");
                v.setVideoPlatform("quarktv2");
        ...
        } catch (Exception e) { return ReturnPageResult.error("quarktv2 搜索失败: " + e.getMessage()); }
    }
}
