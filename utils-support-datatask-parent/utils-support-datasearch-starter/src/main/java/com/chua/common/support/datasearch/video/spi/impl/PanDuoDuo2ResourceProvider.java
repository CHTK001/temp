...
/**
 * 盘多多2 (panduoduo2) 网盘搜索提供器
 */
@Spi("panduoduo2")
public class PanDuoDuo2ResourceProvider extends AbstractResourceProvider {
    public PanDuoDuo2ResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.panduoduo2.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("盘多多2资源");
                v.setVideoPlatform("panduoduo2");
        ...
        } catch (Exception e) { return ReturnPageResult.error("panduoduo2 搜索失败: " + e.getMessage()); }
    }
}
