 ...
 */
@Spi("ypfxw")
public class YpfXwResourceProvider extends AbstractResourceProvider {

    private static final String SEARCH_URL = "https://www.ypfxw.com/s?q=";

    public YpfXwResourceProvider() { super(); }
    public YpfXwResourceProvider(com.chua.common.support.datasearch.video.model.VideoSource vs) { super(vs); }
