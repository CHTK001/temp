...
/**
 * 迅雷搜2 (xunleisou2) 搜索提供器
 */
@Spi("xunleisou2")
public class XunLeiSou2ResourceProvider extends AbstractResourceProvider {
    public XunLeiSou2ResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.xunleisou2.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            java.util.regex.Matcher m = java.util.regex.Pattern.compile("href=\"(magnet:\\?[^\\\"]+)\"").matcher(resp.body());
            int idx = 0;
            while (m.find() && idx++ < 10) {
                VideoInfoResult v = new VideoInfoResult();
                v.setVideoName("迅雷搜2资源");
                v.setVideoPlatform("xunleisou2");
        ...
        } catch (Exception e) { return ReturnPageResult.error("xunleisou2 搜索失败: " + e.getMessage()); }
    }
}
