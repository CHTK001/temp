...
/**
 * 磁力猪2 (cilizhu2) 磁力搜索提供器
 */
@Spi("cilizhu2")
public class CiLiZhu2ResourceProvider extends AbstractResourceProvider {
    public CiLiZhu2ResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.cilizhu2.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("磁力猪2资源");
                v.setVideoPlatform("cilizhu2");
        ...
        } catch (Exception e) { return ReturnPageResult.error("cilizhu2 搜索失败: " + e.getMessage()); }
    }
}
