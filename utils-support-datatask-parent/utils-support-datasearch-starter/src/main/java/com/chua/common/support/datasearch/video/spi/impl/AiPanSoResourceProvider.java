 ...
 */
@Spi("aipanso")
public class AiPanSoResourceProvider extends AbstractResourceProvider {

    private static final String SEARCH_URL = "https://www.aipanso.com/?s=";

    public AiPanSoResourceProvider() { super(); }
    public AiPanSoResourceProvider(com.chua.common.support.datasearch.video.model.VideoSource vs) { super(vs); }
    ...
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            return ReturnPageResult.error("aipanso 搜索失败: " + e.getMessage());
        }
    }
    ...
    private void parseHtml(String html, List<VideoInfoResult> results) {
        ...
        while (m.find() && idx++ < 10) {
            ...
            v.setVideoName("爱盘搜资源");
            v.setVideoPlatform("aipanso");
