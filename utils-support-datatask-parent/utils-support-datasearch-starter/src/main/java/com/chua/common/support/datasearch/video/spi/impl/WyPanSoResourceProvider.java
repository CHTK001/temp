...
/**
 * 网盘搜索 (wypanso) 网盘搜索提供器
 */
@Spi("wypanso")
public class WyPanSoResourceProvider extends AbstractResourceProvider {
    public WyPanSoResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.wypanso.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("wypanso资源");
                v.setVideoPlatform("wypanso");
        ...
        } catch (Exception e) { return ReturnPageResult.error("wypanso 搜索失败: " + e.getMessage()); }
    }
}
