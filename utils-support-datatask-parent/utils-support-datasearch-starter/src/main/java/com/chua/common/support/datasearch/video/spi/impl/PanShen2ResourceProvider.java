...
/**
 * 盘神搜 (panshen2) 网盘搜索提供器
 */
@Spi("panshen2")
public class PanShen2ResourceProvider extends AbstractResourceProvider {
    public PanShen2ResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.panshen2.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("盘神搜资源");
                v.setVideoPlatform("panshen2");
        ...
        } catch (Exception e) { return ReturnPageResult.error("panshen2 搜索失败: " + e.getMessage()); }
    }
}
