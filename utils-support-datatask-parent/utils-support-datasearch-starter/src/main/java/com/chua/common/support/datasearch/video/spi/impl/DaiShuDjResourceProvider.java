...
/**
 * 大书堆 (daishudj) 影视搜索提供器
 */
@Spi("daishudj")
public class DaiShuDjResourceProvider extends AbstractResourceProvider {
    public DaiShuDjResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.daishudj.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("daishudj 搜索失败: " + e.getMessage()); }
    }
}
