...
/**
 * 剧多多 (jutoushe) 影视搜索提供器
 */
@Spi("jutoushe")
public class JuTouSheResourceProvider extends AbstractResourceProvider {
    public JuTouSheResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.jutoushe.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("jutoushe 搜索失败: " + e.getMessage()); }
    }
}
