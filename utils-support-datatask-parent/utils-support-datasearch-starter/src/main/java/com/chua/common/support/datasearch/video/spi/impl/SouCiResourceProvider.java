 ...
 */
@Spi("souci")
public class SouCiResourceProvider extends AbstractResourceProvider {
    public SouCiResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.souci.me/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("souci 搜索失败: " + e.getMessage()); }
    }
}
