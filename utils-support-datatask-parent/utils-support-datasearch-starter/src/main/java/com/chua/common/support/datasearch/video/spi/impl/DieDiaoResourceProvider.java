 ...
 */
@Spi("diediao")
public class DieDiaoResourceProvider extends AbstractResourceProvider {

    private static final String SEARCH_URL = "https://www.diediao.com/?s=";

    public DieDiaoResourceProvider() { super(); }
    public DieDiaoResourceProvider(com.chua.common.support.datasearch.video.model.VideoSource vs) { super(vs); }
    ...
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            return ReturnPageResult.error("diediao 搜索失败: " + e.getMessage());
        }
    }
