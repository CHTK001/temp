 ...
 */
@Spi("ash")
public class AshResourceProvider extends AbstractResourceProvider {
    public AshResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.asian4k.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("ash 搜索失败: " + e.getMessage()); }
    }
}
