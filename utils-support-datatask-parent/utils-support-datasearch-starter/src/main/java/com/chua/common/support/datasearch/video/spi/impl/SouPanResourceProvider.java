 ...
 */
@Spi("soupan")
public class SouPanResourceProvider extends AbstractResourceProvider {
    public SouPanResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.soupan.com/search?q=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("soupan 搜索失败: " + e.getMessage()); }
    }
}
