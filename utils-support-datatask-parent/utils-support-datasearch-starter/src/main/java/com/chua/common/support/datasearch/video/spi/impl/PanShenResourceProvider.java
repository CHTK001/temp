 ...
 */
@Spi("panshen")
public class PanShenResourceProvider extends AbstractResourceProvider {
    public PanShenResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.panshen.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("panshen 搜索失败: " + e.getMessage()); }
    }
}
