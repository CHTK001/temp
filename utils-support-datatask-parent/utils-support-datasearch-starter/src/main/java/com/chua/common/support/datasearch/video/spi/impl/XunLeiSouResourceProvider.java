 ...
 */
@Spi("xunleisou")
public class XunLeiSouResourceProvider extends AbstractResourceProvider {
    public XunLeiSouResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.xunleisou.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("迅雷搜资源");
                v.setVideoPlatform("xunleisou");
        ...
        } catch (Exception e) { return ReturnPageResult.error("xunleisou 搜索失败: " + e.getMessage()); }
    }
}
