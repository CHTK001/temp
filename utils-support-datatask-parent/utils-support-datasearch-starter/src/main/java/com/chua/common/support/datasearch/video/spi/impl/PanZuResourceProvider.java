 ...
 */
@Spi("panzu")
public class PanZuResourceProvider extends AbstractResourceProvider {

    private static final String API_URL = "https://www.panzu.com/api/search";

    public PanZuResourceProvider() { super(); }
    public PanZuResourceProvider(com.chua.common.support.datasearch.video.model.VideoSource vs) { super(vs); }
    ...
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            return ReturnPageResult.error("panzu 搜索失败: " + e.getMessage());
        }
    }
