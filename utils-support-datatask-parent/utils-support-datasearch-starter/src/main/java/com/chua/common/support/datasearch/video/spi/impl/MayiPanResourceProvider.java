 ...
 */
@Spi("mayipan")
public class MayiPanResourceProvider extends AbstractResourceProvider {

    private static final String SEARCH_URL = "https://www.mayipan.com/search?keyword=";

    public MayiPanResourceProvider() { super(); }
    public MayiPanResourceProvider(com.chua.common.support.datasearch.video.model.VideoSource vs) { super(vs); }
    ...
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            return ReturnPageResult.error("mayipan 搜索失败: " + e.getMessage());
        }
    }
    ...
    private void parseHtml(String html, List<VideoInfoResult> results) {
        ...
        while (m.find() && idx++ < 10) {
            ...
            v.setVideoName("蚂蚁盘资源");
            v.setVideoPlatform("mayipan");
