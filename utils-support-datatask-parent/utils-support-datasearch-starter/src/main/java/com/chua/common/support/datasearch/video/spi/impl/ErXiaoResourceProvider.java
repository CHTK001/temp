 ...
 */
@Spi("erxiao")
public class ErXiaoResourceProvider extends AbstractResourceProvider {
    public ErXiaoResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.erxiao.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("erxiao 搜索失败: " + e.getMessage()); }
    }
}
