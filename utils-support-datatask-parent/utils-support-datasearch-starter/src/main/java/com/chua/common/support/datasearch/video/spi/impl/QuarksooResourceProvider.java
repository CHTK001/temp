...
/**
 * 夸克搜 (quarksoo) 网盘搜索提供器
 *
 * @author CH
 * @since 4.0.0.42
 */
@Spi("quarksoo")
public class QuarksooResourceProvider extends AbstractResourceProvider {

    private static final String SEARCH_URL = "https://www.quarksoo.com/search?keyword=";

    public QuarksooResourceProvider() { super(); }
    public QuarksooResourceProvider(com.chua.common.support.datasearch.video.model.VideoSource vs) { super(vs); }
    ...
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            return ReturnPageResult.error("quarksoo 搜索失败: " + e.getMessage());
        }
    }
    ...
    private void parseHtml(String html, List<VideoInfoResult> results) {
        ...
        while (m.find() && idx++ < 10) {
            ...
            v.setVideoPlatform("quarksoo");
            v.setVideoDescription("链接: " + m.group(0));
            results.add(v);
        }
    }
}
