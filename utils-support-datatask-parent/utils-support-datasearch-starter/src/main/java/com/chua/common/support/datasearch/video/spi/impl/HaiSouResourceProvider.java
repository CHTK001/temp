 ...
 */
@Spi("haisou")
public class HaiSouResourceProvider extends AbstractResourceProvider {
    public HaiSouResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.haisou.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("haisou 搜索失败: " + e.getMessage()); }
    }
}
