...
/**
 * 云盘吧 (yunpanba) 网盘搜索提供器
 */
@Spi("yunpanba")
public class YunPanBaResourceProvider extends AbstractResourceProvider {
    public YunPanBaResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.yunpanba.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("云盘吧资源");
                v.setVideoPlatform("yunpanba");
        ...
        } catch (Exception e) { return ReturnPageResult.error("yunpanba 搜索失败: " + e.getMessage()); }
    }
}
