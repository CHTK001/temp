 ...
 * MCP World 在线技能市场提供者。
 *
 * <p>通过 {@code https://www.mcpworld.com/?category=most_popular} 展示 MCP/技能市场。
 *
 * @author CH
 * @since 4.0.0.45
 */
@Spi("mcpworld")
public class McpWorldSkillOnlineProvider extends SkillShProvider implements SkillOnlineProvider {
