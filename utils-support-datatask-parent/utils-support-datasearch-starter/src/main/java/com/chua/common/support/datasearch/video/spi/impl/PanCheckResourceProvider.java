...
/**
 * 盘查查 (pancheck) 网盘搜索提供器
 *
 * @author CH
 * @since 4.0.0.42
 */
@Spi("pancheck")
public class PanCheckResourceProvider extends AbstractResourceProvider {

    private static final String SEARCH_URL = "https://www.pancheck.cn/search?keyword=";

    public PanCheckResourceProvider() { super(); }
    public PanCheckResourceProvider(com.chua.common.support.datasearch.video.model.VideoSource vs) { super(vs); }
    ...
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            return ReturnPageResult.error("pancheck 搜索失败: " + e.getMessage());
        }
    }
    ...
    private void parseHtml(String html, List<VideoInfoResult> results) {
        ...
        while (m.find() && idx++ < 10) {
            ...
            v.setVideoName("盘查查资源");
            v.setVideoPlatform("pancheck");
