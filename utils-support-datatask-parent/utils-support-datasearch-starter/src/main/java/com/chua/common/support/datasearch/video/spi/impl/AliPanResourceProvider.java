 ...
 */
@Spi("alipan")
public class AliPanResourceProvider extends AbstractResourceProvider {
    public AliPanResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.alipan.com/search?keyword=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            java.util.regex.Matcher m = java.util.regex.Pattern.compile("https?://[\\w.:/]+aliyundrive\\.com/[\\w/]+").matcher(resp.body());
            int idx = 0;
            while (m.find() && idx++ < 10) {
                VideoInfoResult v = new VideoInfoResult();
                v.setVideoName("阿里云盘资源");
                v.setVideoPlatform("alipan");
        ...
        } catch (Exception e) { return ReturnPageResult.error("alipan 搜索失败: " + e.getMessage()); }
    }
}
