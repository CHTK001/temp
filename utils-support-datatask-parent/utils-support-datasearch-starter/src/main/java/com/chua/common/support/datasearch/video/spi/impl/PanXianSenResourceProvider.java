...
/**
 * 盘先森 (panxiansen) 网盘搜索提供器
 */
@Spi("panxiansen")
public class PanXianSenResourceProvider extends AbstractResourceProvider {
    public PanXianSenResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.panxiansen.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("盘先森资源");
                v.setVideoPlatform("panxiansen");
        ...
        } catch (Exception e) { return ReturnPageResult.error("panxiansen 搜索失败: " + e.getMessage()); }
    }
}
