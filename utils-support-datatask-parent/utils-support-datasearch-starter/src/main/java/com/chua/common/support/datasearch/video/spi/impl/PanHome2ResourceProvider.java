...
/**
 * 网盘之家 (panhome2) 网盘搜索提供器
 */
@Spi("panhome2")
public class PanHome2ResourceProvider extends AbstractResourceProvider {
    public PanHome2ResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.panhome2.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("panhome2 搜索失败: " + e.getMessage()); }
    }
}
