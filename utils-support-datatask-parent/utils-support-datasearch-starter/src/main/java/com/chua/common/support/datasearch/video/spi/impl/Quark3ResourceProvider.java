 ...
 */
@Spi("quark3")
public class Quark3ResourceProvider extends AbstractResourceProvider {
    public Quark3ResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.quark3.com/search?keyword=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("夸克搜资源");
                v.setVideoPlatform("quark3");
        ...
        } catch (Exception e) { return ReturnPageResult.error("quark3 搜索失败: " + e.getMessage()); }
    }
}
