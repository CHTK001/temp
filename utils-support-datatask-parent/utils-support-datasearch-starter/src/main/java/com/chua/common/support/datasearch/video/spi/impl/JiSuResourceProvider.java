 ...
 */
@Spi("jisu")
public class JiSuResourceProvider extends AbstractResourceProvider {
    public JiSuResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.jisu.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("极速盘资源");
                v.setVideoPlatform("jisu");
        ...
        } catch (Exception e) { return ReturnPageResult.error("jisu 搜索失败: " + e.getMessage()); }
    }
}
