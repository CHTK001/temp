 ...
 */
@Spi("feikuai")
public class FeiKuaiResourceProvider extends AbstractResourceProvider {
    public FeiKuaiResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.feikuai.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("feikuai 搜索失败: " + e.getMessage()); }
    }
}
