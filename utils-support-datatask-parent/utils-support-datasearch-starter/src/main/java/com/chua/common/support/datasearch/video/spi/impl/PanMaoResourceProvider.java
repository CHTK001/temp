 ...
 */
@Spi("panmao")
public class PanMaoResourceProvider extends AbstractResourceProvider {
    public PanMaoResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.panmao.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("panmao 搜索失败: " + e.getMessage()); }
    }
}
