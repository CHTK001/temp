...
/**
 * 趣盘搜 (qupansou) 网盘搜索提供器
 *
 * @author CH
 * @since 4.0.0.42
 */
@Spi("qupansou")
public class QupansouResourceProvider extends AbstractResourceProvider {

    private static final String API_URL = "https://www.qupansou.com/api/search";

    public QupansouResourceProvider() { super(); }
    public QupansouResourceProvider(com.chua.common.support.datasearch.video.model.VideoSource vs) { super(vs); }
    ...
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            return ReturnPageResult.error("qupansou 搜索失败: " + e.getMessage());
        }
    }
