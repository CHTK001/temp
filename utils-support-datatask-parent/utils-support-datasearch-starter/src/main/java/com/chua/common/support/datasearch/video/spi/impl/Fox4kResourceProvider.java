 ...
 */
@Spi("fox4k")
public class Fox4kResourceProvider extends AbstractResourceProvider {
    public Fox4kResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.fox4k.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("fox4k 搜索失败: " + e.getMessage()); }
    }
}
