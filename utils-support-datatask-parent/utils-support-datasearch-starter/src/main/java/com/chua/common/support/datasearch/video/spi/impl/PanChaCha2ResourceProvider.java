...
/**
 * 盘查查2 (panchacha2) 网盘搜索提供器
 */
@Spi("panchacha2")
public class PanChaCha2ResourceProvider extends AbstractResourceProvider {
    public PanChaCha2ResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.panchacha2.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
            ...
            while (m.find() && idx++ < 10) {
                ...
                v.setVideoName("盘查查2资源");
                v.setVideoPlatform("panchacha2");
        ...
        } catch (Exception e) { return ReturnPageResult.error("panchacha2 搜索失败: " + e.getMessage()); }
    }
}
