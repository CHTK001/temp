 ...
 */
@Spi("panyou")
public class PanYouResourceProvider extends AbstractResourceProvider {
    public PanYouResourceProvider() { super(); }
    @Override
    public ReturnPageResult<VideoInfoResult> searchResource(VideoSearch videoSearch) {
        ...
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder().uri(URI.create("https://www.panyou.com/?s=" + java.net.URLEncoder.encode(kw, "UTF-8")))
        ...
        } catch (Exception e) { return ReturnPageResult.error("panyou 搜索失败: " + e.getMessage()); }
    }
}
