...
/**
 * H2 元数据入口，提供对象化 DDL（建表/删表/重命名）。
 *
 * <p>通过 SPI 注册，H2Engine.meta() 自动加载。</p>
 *
 * @author CH
 * @since 4.0.0.42
 */
public class H2MetaData extends AbstractMetaData {
    ...
    public MetaView view() {
        throw new UnsupportedOperationException("H2 暂不支持视图元数据操作");
    }
    ...
    public MetaIndex index() {
        throw new UnsupportedOperationException("H2 暂不支持索引入口操作");
    }
    ...
    public MetaTrigger trigger() {
        throw new UnsupportedOperationException("H2 暂不支持触发器元数据操作");
    }
    ...
    public MetaProcedure procedure() {
        throw new UnsupportedOperationException("H2 暂不支持存储过程元数据操作");
    }
    ...
    public MetaForeignKey fk() {
        throw new UnsupportedOperationException("H2 暂不支持外键元数据操作");
    }
    ...
    public MetaSearch search() {
        throw new UnsupportedOperationException("H2 暂不支持搜索引擎索引操作");
    }
