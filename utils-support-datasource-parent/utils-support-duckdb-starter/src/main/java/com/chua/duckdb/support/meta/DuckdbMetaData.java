package com.chua.duckdb.support.meta;
 ...
 * @since 4.0.0.42
 */
public class DuckdbMetaData extends AbstractMetaData {
    ...
    public MetaView view() {
        throw new UnsupportedOperationException("DuckDB 暂不支持视图元数据操作");
    }
    ...
    public MetaIndex index() {
        throw new UnsupportedOperationException("DuckDB 暂不支持索引入口操作");
    }
    ...
    public MetaTrigger trigger() {
        throw new UnsupportedOperationException("DuckDB 暂不支持触发器元数据操作");
    }
    ...
    public MetaProcedure procedure() {
        throw new UnsupportedOperationException("DuckDB 暂不支持存储过程元数据操作");
    }
    ...
    public MetaForeignKey fk() {
        throw new UnsupportedOperationException("DuckDB 暂不支持外键元数据操作");
    }
    ...
    public MetaSearch search() {
        throw new UnsupportedOperationException("DuckDB 暂不支持搜索引擎索引操作");
    }
    ...
    public MetaUser user() {
        throw new UnsupportedOperationException("DuckDB 暂不支持用户元数据操作");
    }

    @Override
    public MetaPermission permission() {
        throw new UnsupportedOperationException("DuckDB 暂不支持权限元数据操作");
    }
}