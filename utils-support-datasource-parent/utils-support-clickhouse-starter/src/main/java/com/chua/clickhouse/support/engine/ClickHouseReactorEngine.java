...
/**
 * ClickHouse 响应式引擎，对应同步侧 {@link ClickHouseEngine}。
 *
 ...
 * 自动转换为 R2DBC 连接（需 classpath 存在 clickhouse-r2dbc 驱动）。</p>
 *
 * <pre>{@code
...
public class ClickHouseReactorEngine extends JdbcReactorEngine {
    ...
    /**
     * 创建 ClickHouse 响应式引擎，内部持有同步 {@link ClickHouseEngine}。
     */
