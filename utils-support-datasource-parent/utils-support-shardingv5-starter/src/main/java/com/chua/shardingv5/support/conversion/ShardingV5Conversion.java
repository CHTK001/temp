...
public class ShardingV5Conversion implements DataSourceConversion {
    ...
    /**
     * 注册自定义算法实现类。CLASS_BASED 要求类有无参构造器。
     */
    ...
    /**
     * 注册内置算法（MOD / HASH_MOD / INTERVAL 等）。
     */
    ...
    /**
     * 确保算法已注册；内置算法自动注册并设 sharding-count
     */
